...
(async function main(){
  ...
  await putRow({m,ko,koFix,locked,updatedAt:Date.now()});
  console.log(`Synced ${Object.keys(m).length} group + ${Object.keys(ko).length} KO scores, ${koFix.length} KO fixtures via ${FD_KEY?"football-data.org":"openfootball"}.`);
